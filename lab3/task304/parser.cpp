...
#line 1737 "parser.cpp"
  ...
  case 19:
#line 139 "parser.y"
                         {(yyval.nFunDec)=new NFunDec(*(new NIdentifier(*(new std::string((yyvsp[-3].type_id))))),(yyvsp[-1].nVarList));(yyval.nFunDec)->line=(yyvsp[-1].nVarList)->line;}
...
#line 1809 "parser.cpp"
  ...
  case 31:
#line 158 "parser.y"
                                      {(yyval.nStmt)=new NWhileStmt(*(yyvsp[-4].nExpression),*(yyvsp[-2].nStmt));(yyval.nStmt)->line=yylineno;}
...
#line 1965 "parser.cpp"
  ...
  case 57:
#line 198 "parser.y"
                        {(yyval.nExpression)=new NBinaryOperator(*(new std::string("MOD")),*(yyvsp[-2].nExpression),DIV,*(yyvsp[0].nExpression));(yyval.nExpression)->line=(yyvsp[-2].nExpression)->line;}
...
#line 1989 "parser.cpp"
  ...
  case 61:
#line 203 "parser.y"
                        {(yyval.nExpression)=new NMethodCall(*(new NIdentifier(*(new std::string((yyvsp[-3].type_id))))),(yyvsp[-1].nArgs));(yyval.nExpression)->line=(yyvsp[-2].line);}
#line 1995 "parser.cpp"
    break;

  case 62:
#line 204 "parser.y"
                        {(yyval.nExpression)=new NMethodCall(*(new NIdentifier(*(new std::string((yyvsp[-2].type_id))))),nullptr);(yyval.nExpression)->line=(yyvsp[-1].line);}
...
#line 2007 "parser.cpp"
  ...
  case 64:
#line 206 "parser.y"
                        {(yyval.nExpression)=new NDotOperator(*(yyvsp[-2].nExpression),*(new NIdentifier(*(new std::string((yyvsp[0].type_id))))));(yyval.nExpression)->line=(yyvsp[-2].nExpression)->line;}
