...
static const yytype_uint8 yyrline[] =
{
     ...
     134,   137,   140,   141,   144,   146,   149,   155,   156,   159,
     160,   163,   164,   167,   172,   175,   176,   179,   180,   181,
     182,   183,   184,   185,   190,   191,   194,   197,   198,   201,
     202,   207,   208,   209,   210,   211,   213,   214,   215,   216,
...
#line 1681 "parser.cpp"
  ...
  case 10:
#line 134 "parser.y"
                                { /*if ($1[0] == 'i') $$ = new NSpecifier(*(new std::string("int")));
...
#line 1707 "parser.cpp"
  ...
  case 14:
#line 144 "parser.y"
                                { (yyval.nOptTag) = new NOptTag(*(new NIdentifier((yyvsp[0].type_id)))); 
                                (yyval.nOptTag)->line = atoi((yyvsp[0].type_id) + strlen((yyvsp[0].type_id)) + 1); }
...
#line 1720 "parser.cpp"
  ...
  case 16:
#line 149 "parser.y"
                                { (yyval.nTag) = new NTag(*(new NIdentifier((yyvsp[0].type_id)))); 
                                (yyval.nTag)->line = yylineno; }
